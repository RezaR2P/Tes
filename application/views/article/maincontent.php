...
<div class="basis-8/12 mt-4" id="maincontent">
    ...
    <a href="" data-lightbox="<?= $content->coverImage; ?>" data-alt="<?= $content->coverImage; ?>"><img src="<?= base_url('assets/img/content/') . $content->coverImage; ?>" class="mx-auto w-auto max-h-[28rem] rounded-lg shadow-xl dark:shadow-gray-800" alt="Responsive image"></a>
