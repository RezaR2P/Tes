...
<div class="basis-8/12 " id="content">
    ...
    <form action="<?= base_url('article/prosesedit') ?>" method="post" enctype="mulripart/form-data">
        ...
        <?php endif; ?>
            ...
            <input type="hidden" class="" name="id_article" value="<?= $content->id_article; ?>">
            ...
            <div class="mb-6">
                ...
                <select id="category" name="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    <option  value="berita" <?= (($content->category == 'berita' ) ? "selected":"") ?>>Berita</option>
                    <option value="artikel" <?= (($content->category == 'artikel' ) ? "selected":"") ?>>Artikel</option>
                    <option value="pengumuman" <?= (($content->category == 'pengumuman' ) ? "selected":"") ?>>Pengumuman</option>
                </select>
            </div>
            <div class="mb-6">
                ...
                <div class="flex gap-4">
                    <div class="basis-4/12">
                        <img src="<?= base_url('assets/img/content/') . $content->coverImage; ?>" id="preview" class="border-4 border-slate-700 shadow-lg rounded-lg max-w-full">
                    </div>
                    <div class="basis-8/12 ">
                        <input type="file" name="gambar" class="file d-none">

                        <div class="input-group ">
                            <input type="text" class="form-control bg-gray-50 border border-gray-300 text-gray-900 rounded-lg" disabled placeholder="<?= $content->coverImage; ?>" id="file">
